...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Experience authentic Italian cuisine in an elegant atmosphere. Our chefs craft each dish with passion using the finest ingredients and traditional recipes passed down through generations.',
  contactEmail: 'info@bellavista.com',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Culinary Street, Downtown',
  newsletterTitle: 'Stay Updated',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer: 'Get updates on special events, seasonal menus, and exclusive offers.',
  section1Title: 'Menu',
  ...
  linkFeaturesHref: '/menu#appetizers',
  linkPricing: 'Main Courses',
  linkPricingHref: '/menu#mains',
  linkTemplates: 'Desserts',
  linkTemplatesHref: '/menu#desserts',
  linkIntegrations: 'Wine List',
  linkIntegrationsHref: '/menu#wine',
  linkApi: "Chef's Special",
  linkApiHref: '/menu#specials',
  linkDocumentation: 'Seasonal Menu',
  linkDocumentationHref: '/menu#seasonal',
  // Experience Links
  linkAbout: 'Our Story',
  linkAboutHref: '/about',
  linkBlog: 'Events',
  linkBlogHref: '/events',
  linkCareers: 'Private Dining',
  linkCareersHref: '/private-dining',
  linkPress: 'Gallery',
  linkPressHref: '/gallery',
  linkPartners: 'Reviews',
  linkPartnersHref: '/reviews',
  linkContact: 'Location',
  linkContactHref: '/location',
  // Services Links
  linkHelp: 'Reservations',
  linkHelpHref: '/reservations',
  linkCommunity: 'Online Ordering',
  linkCommunityHref: '/order',
  linkTutorials: 'Catering',
  linkTutorialsHref: '/catering',
  linkWebinars: 'Gift Cards',
  linkWebinarsHref: '/gift-cards',
  linkCaseStudies: 'Delivery',
  linkCaseStudiesHref: '/delivery',
  linkStatus: 'Takeout',
  linkStatusHref: '/takeout',
  // Info Links
  linkPrivacy: 'Privacy Policy',
  linkPrivacyHref: '/privacy',
  linkTerms: 'Terms of Service',
  linkTermsHref: '/terms',
  linkCookies: 'Allergen Info',
  linkCookiesHref: '/allergens',
  linkGdpr: 'Nutrition',
  linkGdprHref: '/nutrition',
  linkSecurity: 'Food Safety',
  linkSecurityHref: '/food-safety',
  linkCompliance: 'Accessibility',
  linkComplianceHref: '/accessibility',
  // Bottom Links
  linkSitemap: 'Sitemap',
  ...
  // Restaurant specific
  hoursTitle: 'Hours',
  mondayFriday: 'Mon - Fri: 5:00 PM - 10:00 PM',
...
export default function Footer(props: FooterProps) {
  ...
  // Restaurant-focused footer sections
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  <div data-editable="mondayFriday">{config.mondayFriday}</div>
                  <div data-editable="saturday">{config.saturday}</div>
                  <div data-editable="sunday">{config.sunday}</div>
                </div>
              </div>
